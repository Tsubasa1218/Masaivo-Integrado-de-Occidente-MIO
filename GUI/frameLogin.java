...
public class frameLogin extends javax.swing.JFrame {
    ...
    private void logInButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_logInButtonActionPerformed
        ...
        String user_login = userLoginTF.getText();
        char password[] = passwordLoginTF.getPassword();
        ...
        int tipo = user.validarUsuario(user_login, passwordString);
        String nombre = user.getNombre();
        
        switch (tipo) {
            case 1:
                frameConductor frameConductor = new frameConductor();
                frameConductor.setVisible(true);
                frameConductor.setCedulaConductor(user_login);
                frameConductor.setNombreConductor(nombre);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                //new frameAuxiliar().setVisible(true);
                //ew frameDirectorOperativo().setVisible(true);
